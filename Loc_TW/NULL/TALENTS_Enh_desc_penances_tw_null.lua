...
--[+ +PENANCES+ +]--
	...
	local ED_No_missed_shots_rgb_ru = ""

	local ED_On_heresy_volley_rgb_ru = ""

	local ED_Long_bomb_rgb_ru = ""

	local ED_Unseen_predator_rgb_ru = ""

	local ED_Blessed_be_thine_aim_rgb_ru = ""

	local ED_Buying_time_rgb_ru = ""

	local ED_Unleash_warp_rgb_ru = ""

	local ED_Cliffhanger_rgb_ru = ""

	local ED_Warp_battery_rgb_ru = ""

	local ED_Pick_n_mix_rgb_ru = ""

	local ED_Dont_stop_me_now_rgb_ru = ""

	local ED_Something_in_your_eye_rgb_ru = ""

	local ED_Heavyweight_champion_rgb_ru = ""

	local ED_Im_in_charge_rgb_ru = ""
