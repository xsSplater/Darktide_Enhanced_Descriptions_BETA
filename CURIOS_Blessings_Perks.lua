...
--[+ +CURIOS - РЕЛИКВИИ+ +]--
	...
	--[+ Russian +]--
	create_template("curio_bless0_ext_en", {"loc_inate_gadget_health_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_maxhlth_rgb.." к максимальному "..COLORS_KWords_ru.Health_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_bless1_ext_en", {"loc_inate_gadget_health_segment_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_maxwnds_rgb.." сегмент полоски "..COLORS_KWords_ru.Wound_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_bless2_ext_en", {"loc_inate_gadget_stamina_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_maxstam_rgb.." к максимальной "..COLORS_KWords_ru.Stamina_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_bless3_ext_en", {"loc_inate_gadget_toughness_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_maxtghns_rgb.." к максимальной "..COLORS_KWords_ru.Toughness_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_traits0_ext_en", {"loc_gadget_cooldown_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_abil_cd_rgb.." к восстановлению "..COLORS_KWords_ru.Combat_ability_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_traits1_ext_en", {"loc_gadget_corruption_resistance_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_corr_rgb.." к сопротивлению "..COLORS_KWords_ru.Corruption_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_traits2_ext_en", {"loc_gadget_grim_corruption_resistance_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_corrgrm_rgb.." к сопротивлению "..COLORS_KWords_ru.Corruption_rgb_ru.." от гримуаров" end),
	...
	--[+ Russian +]--
	create_template("curio_traits3_ext_en", {"loc_trait_gadget_health_increase_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_maxhlth_rgb.." к максимальному "..COLORS_KWords_ru.Health_rgb_ru end),
	...
	create_template("curio_traits4_ext_en", {"loc_gadget_block_cost_reduction_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_blckcst_rgb.." к снижение стоимости блока" end),
		...
		--[+ -Stamina Cost for Sprinting +]-- Duplicate. There is the same in Weapon Blessings!
	...
	--[+ Russian +]--
	-- create_template("curio_traits5_ext_en", {"loc_gadget_sprint_cost_reduction_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.m_bcm_rgb.." к затратам "..COLORS_KWords_ru.Stamina_rgb_ru.." на бег" end),
	...
	--[+ Russian +]--
	create_template("curio_traits7_ext_en", {"loc_gadget_stamina_regeneration_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_stamreg_rgb.." к восстановлению "..COLORS_KWords_ru.Stamina_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_traits8_ext_en", {"loc_trait_gadget_toughness_increase_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_maxtghns_rgb.." "..COLORS_KWords_ru.Toughness_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_traits9_ext_en", {"loc_gadget_toughness_regen_delay_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_tghn_reg_del_rgb.." к скорости восстановления "..COLORS_KWords_ru.Toughness_rgb_ru end),
	...
	--[+ Russian +]--
	create_template("curio_traits13_ext_en", {"loc_trait_gadget_dr_vs_flamer_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_dmg_red_rgb.." сопротивления "..COLORS_KWords_ru.Damage_rgb_ru.." от Огнемётчиков" end),
	...
	--[+ Russian +]--
	create_template("curio_traits14_ext_en", {"loc_trait_gadget_dr_vs_grenadiers_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_dmg_red_rgb.." сопротивления "..COLORS_KWords_ru.Damage_rgb_ru.." от Гренадёров" end),
	...
	--[+ Russian +]--
	create_template("curio_traits15_ext_en", {"loc_trait_gadget_dr_vs_gunners_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_dmg_red_rgb.." сопротивления "..COLORS_KWords_ru.Damage_rgb_ru.." от Пулемётчиков" end),
	...
	--[+ Russian +]--
	create_template("curio_traits16_ext_en", {"loc_trait_gadget_dr_vs_hounds_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_dmg_red_rgb.." сопротивления "..COLORS_KWords_ru.Damage_rgb_ru.." от Чумных гончих" end),
	...
	--[+ Russian +]--
	create_template("curio_traits17_ext_en", {"loc_trait_gadget_dr_vs_mutants_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_dmg_red_rgb.." сопротивления "..COLORS_KWords_ru.Damage_rgb_ru.." от Мутантов" end),
	...
	--[+ Russian +]--
	create_template("curio_traits18_ext_en", {"loc_trait_gadget_dr_vs_snipers_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_dmg_red_rgb.." сопротивления "..COLORS_KWords_ru.Damage_rgb_ru.." от Снайперов" end),
	...
	--[+ Russian +]--
	-- create_template("curio_traits19_ext_en", {"loc_trait_gadget_dr_vs_bursters_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.p_dmg_red_rgb.." сопротивления "..COLORS_KWords_ru.Damage_rgb_ru.." от Чумных взрывников" end), -- Вырезано!
}
