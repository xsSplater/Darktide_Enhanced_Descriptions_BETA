...
--[+ ++WEAPON - PERKS - 武器专长++ +]--
	--[+ MELEE - 近戰武器 - 近战武器 +]--
		...
		["loc_trait_melee_common_wield_increase_stamina_desc"] = { -- stamina: +2
			...
			["zh-cn"] = CNumb("{stamina:%s}", "stam_var_rgb").." 最大"..CKWord("耐力", "Stamina_rgb_zh_cn"),
		...
		["loc_gadget_sprint_cost_reduction_desc"] = { -- 
			...
			["zh-cn"] = CNumb("{sprinting_cost_multiplier:%s}", "bcm_rgb").." 疾跑"..CKWord("耐力", "Stamina_rgb_zh_cn").."效益",
	...
	--[+ RANGED - 遠程武器 - 远程武器 +]--
		...
		["loc_trait_ranged_common_wield_increase_stamina_desc"] = {
			...
			["zh-cn"] = CNumb("{stamina:%s}", "stam_var_rgb").." 最大"..CKWord("耐力", "Stamina_rgb_zh_cn").."（使用武器时）",
...
--[+ ++WEAPON BLESSINGS - БЛАГОСЛОВЕНИЯ ОРУЖИЯ - 武器祝福++ +]--
	--[+ MELEE - БЛИЖНИЙ БОЙ - 近戰 +]--
		...
		["loc_trait_bespoke_melee_rending_vs_staggered_desc"] = { -- rending: +25%, +colors, +note
			...
			["zh-tw"] = "對"..CKWord("踉蹌", "Staggered_rgb_tw").."敵人獲得 "..CNumb("{rending:%s}", "rending_var_rgb").." 近戰"..CKWord("撕裂", "Rending_rgb_tw").."。\n"
				..CNote("Rend_note"),
			["zh-cn"] = "对抗"..CKWord("踉跄", "Stagger_rgb_zh_cn").."敌人时，"..CNumb("{rending:%s}", "rending_var_rgb").." 近战"..CKWord("撕裂", "Rending_rgb_zh_cn").."。\n"
				..CNote("Rend_note"),
	...
	--[+ SHRED +]-- ruof Расстрел	20.04.2026
		...
		["loc_trait_bespoke_infinite_melee_cleave_on_crit_desc"] = { -- hit_mass: +80%, time: 5, +colors, +added info
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时 "..CNumb("{hit_mass:%s}", "hitmass_var_rgb").." "..CKWord("劈裂值", "Cleave_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。",
		...
		["loc_trait_bespoke_bleed_on_crit_melee_desc"] = { -- stacks: +8, +colors
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时 ".. CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("流血", "Bleed_rgb_zh_cn").."。\n最多叠加 "..CNumb("16", "n_16_rgb").." 层。",
		...
		["loc_trait_bespoke_staggered_targets_receive_increased_damage_debuff_desc"] = { -- stacks: 4, damage: +10%, time: 5, Stack(s)->Stacks, +colors
			...
			["zh-tw"] = "若目標已處於"..CKWord("踉蹌", "Staggered_rgb_tw").."狀態，使其獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."，目標最多 "..CNumb("8", "n_8_rgb").." 層。持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr"),
			["zh-cn"] = "对"..CKWord("踉跄", "Stagger_rgb_zh_cn").."敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("伤害", "Damage_rgb_zh_cn").."效果，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("8", "n_8_rgb").." 层。",
		...
		["loc_trait_bespoke_staggered_targets_receive_increased_stagger_debuff_desc"] = { -- stacks: 4, impact: +10%, time: 5, Stack(s)->Stacks, +colors
			...
			["zh-tw"] = "若目標已處於"..CKWord("踉蹌", "Staggered_rgb_tw").."狀態，使其獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("衝擊", "Impact_rgb_tw").."，目標最多 "..CNumb("8", "n_8_rgb").." 層。持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr"),
			["zh-cn"] = "对"..CKWord("踉跄", "Stagger_rgb_zh_cn").."敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("冲击", "Impact_rgb_zh_cn").."效果，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多叠加 "..CNumb("8", "n_8_rgb").." 层。",
		...
		["loc_trait_bespoke_pass_past_armor_on_crit_new_desc"] = { -- crit_damage: +10%, +colors
			...
			["zh-cn"] = "近战"..CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时 "..CNumb("{crit_damage:%s}", "critdmg_var_rgb")..CKWord("", "Damage_rgb_zh_cn").."。\n"..CKWord("暴击", "Crit0_rgb_zh_cn").."同时无视装甲赋予的"..CKWord("打击质量", "Hit_mass_rgb_zh_cn").."。"..CNote("Hit_Mass_note"),
		...
		["loc_trait_bespoke_warp_burninating_on_crit_desc"] = { -- stacks: +4, max_stacks: 12, Stack(s)->Stacks, +colors
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时, 对敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("灵魂之火", "Soulblaze_rgb_zh_cn").."。最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_wind_slash_crits_desc"] = { -- cooldown: 50, s->seconds, +colors
			...
			["zh-cn"] = "使下次充能攻击必定"..CKWord("暴击", "Crit_hit_rgb_zh_cn").."，\n冷却时间 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒。",
		...
		["loc_trait_block_break_pushes_new_desc"] = { -- block_cost: -30%, cooldown: 15, +colors
			...
			["zh-cn"] = CNumb("{block_cost:%s}", "block_var_rgb").." 格挡消耗。格挡期间"..CKWord("耐力", "Stamina_rgb_zh_cn").."耗尽时，\n推开 "..CNumb("5", "n_5_rgb").." 米内的敌人，冷却时间 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒。",
		...
		["loc_trait_damage_bonus_on_block_desc"] = { -- power: +10%, duration: 3.5, stacks: 5, +colors -- ..CNote("Pwr_note_rgb
			...
			["zh-cn"] = "格挡期间，每消耗 "..CNumb("1", "n_1_rgb").." "..CKWord("耐力", "Stamina_rgb_zh_cn").." "..CNumb("{power:%s}", "pwr_var_rgb").." 近战"..CKWord("强度", "Strength_rgb_zh_cn").."，\n持续 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。"..CNote("Pwr_note"),
	...
	--[+ RANGED - ДАЛЬНИЙ БОЙ - 远程武器 +]-- ruof Обстрел
		...
		["loc_trait_bespoke_increased_sprint_speed_desc"] = { -- stamina: 50%, +colors
			...
			["zh-cn"] = "以超过 "..CNumb("{stamina:%s}", "stam_var_rgb").." "..CKWord("耐力", "Stamina_rgb_zh_cn").."疾跑时，\n闪避全部远程攻击。",
		...
		["loc_trait_bespoke_crit_weakspot_finesse_desc"] = { -- crit_weakspot_damage: +100%, +colors
			...
			["zh-cn"] = CNumb("{crit_weakspot_damage:%s}", "critwkspdmg_var_rgb").." "..CKWord("暴击", "Crit_hit_rgb_zh_cn")..""..CKWord("弱点伤害", "Weakspot_dmg_rgb_zh_cn").."。",
		...
		["loc_trait_bespoke_damage_vs_stagger_desc"] = { -- vs_stagger: 20%, +colors
			...
			["zh-cn"] = "对"..CKWord("踉跄", "Stagger_rgb_zh_cn").."敌人 "..CNumb("{vs_stagger:%s}", "dmgvsstgr_var_rgb").." "..CKWord("伤害", "Damage_rgb_zh_cn").."。",
		...
		["loc_trait_bespoke_warpfire_burn_on_crit_desc"] = { -- stacks: 4, +colors -- REMOVED: [Up to 6 Stacks.] because for some reason this description is used for the Psyker Greatsword, but it has 12 stacks max. Fatshark FFS!
			...
			["zh-tw"] = CKWord("致命一擊", "Crit_hit_rgb_tw").."時，對敵人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("靈魂之火", "Soulblaze_rgb_tw").."。 "
				..CPhrs("Refr_dur_stappl"),
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时, 对敌人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CKWord("灵魂之火", "Soulblaze_rgb_zh_cn").."。",
		...
		["loc_trait_bespoke_burninating_on_crit_desc"] = { -- stacks: +4, max_stacks: 12, Stack(s)->Stacks, +colors
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层"..CKWord("燃烧", "Burn_rgb_zh_cn").."。最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层。",
		...
		["loc_trait_bespoke_rending_on_crit_desc"] = { -- rend: +60%, +colors
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").." "..CNumb("{rend:%s}", "rend_var_rgb").." "..CKWord("撕裂", "Rending_rgb_zh_cn").."。"..CNote("Rend_note"),
		...
		["loc_trait_bespoke_ammo_spent_from_reserve_on_crit_desc"] = { -- +colors
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时，从弹药储备填装数枚弹药。",
		...
		["loc_trait_bespoke_reduced_overheat_on_crits_desc"] = { -- +colors
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时，减少 "..CNumb("{heat_percentage:%s}", "heat_pc_var_rgb").." "..CKWord("热量", "Heat_rgb_zh_cn").."积累。",
		...
		["loc_trait_bespoke_ammo_refill_from_reserve_on_crit_desc"] = { -- bullet_amount: +5, +colors
			...
			["zh-cn"] = CKWord("暴击命中", "Crit_hit_rgb_zh_cn").."时，从弹药储备填装 "..CNumb("{bullet_amount:%s}", "blltam_var_rgb").." 枚弹药。",
