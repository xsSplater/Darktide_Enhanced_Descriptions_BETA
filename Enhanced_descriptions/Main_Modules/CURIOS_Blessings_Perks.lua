...
--[+ ++CURIOS - РЕЛИКВИИ - 珍品++ +]--
	--[+ +BLESSINGS - БЛАГОСЛОВЕНИЯ - 祝福+ +]--
		...
		["loc_inate_gadget_stamina_desc"] = { -- stamina_modifier: +3
			...
			["zh-cn"] = CNumb("{stamina_modifier:%s}", "maxstam_rgb").." 最大"..CKWord("耐力", "Stamina_rgb_zh_cn"),
	...
	--[+ TRAITS - ХАРАКТЕРИСТИКИ - 附加屬性 +]--
		...
		["loc_gadget_stamina_regeneration_desc"] = { -- stamina_regeneration_modifier: +12%
			...
			["zh-cn"] = CNumb("{stamina_regeneration_modifier:%s}", "stamreg_rgb").." "..CKWord("耐力", "Stamina_rgb_zh_cn").."复",
