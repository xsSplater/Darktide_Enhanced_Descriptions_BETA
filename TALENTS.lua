...
--[+ +NODES - УЗЛЫ+ +]--
	...
	--[+ Russian +]--
	create_template("talent_tree_oper_mod_003_desc_ru", {"loc_talent_coherency_regen_low_desc"}, {"ru"}, function(locale, value) return "{coherency_regen:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восполняется для вас и союзников под сплочённостью."..TALENTS_Enh_desc_nodes_ru.ED_InspiringP_rgb_ru end),
...
--[+ +BLITZ - БЛИЦ+ +]--
	...
	create_template("talent_tree_psy_blitz2_002_desc_ru", {"loc_talent_psyker_chain_lightning_damage_heavy_attacks_desc"}, {"ru"}, function(locale, value) return "Ваши тяжёлые атаки ближнего боя накладывают на врагов эффект "..COLORS_KWords_ru.Electrocution_rgb_ru..", наносящий им "..COLORS_KWords_ru.Dmg_rgb_ru.."."..TALENTS_Enh_desc_ru.ED_PSY_Blitz_2_3_rgb_ru end),
...
--[+ +ABILITIES - СПОСОБНОСТИ+ +]--
	...
	create_template("talent_tree_psy_abil2_002_desc_ru", {"loc_talent_psyker_force_field_stun_increased_description"}, {"ru"}, function(locale, value) return "{ability:%s} имеет {proc_chance:%s} шанс "..COLORS_KWords_ru.Staggering_rgb_ru.." врагов, которые проходят через него. Враги-специалисты имеют {special_proc_chance:%s} шанс "..COLORS_KWords_ru.Staggering_rgb_ru..", но также повреждают {ability:%s}."..TALENTS_Enh_desc_ru.ED_PSY_Ability_2_2_rgb_ru end),
	...
	create_template("talent_tree_psy_abil2_004_desc_ru", {"loc_talent_psyker_force_field_grants_toughness_desc"}, {"ru"}, function(locale, value) return "{toughness:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." в секунду восстанавливается для союзников, которых защищает ваш {talent_name:%s}.\n{toughness_damage_reduction:%s} к "..COLORS_KWords_ru.Toughness_dmg_red_u_rgb_ru.." на {duration:%s} секунд получают все союзники, которых защищал ваш {talent_name:%s}, в момент его рассеивания."..TALENTS_Enh_desc_ru.ED_PSY_Ability_2_4_rgb_ru end),
	...
	create_template("talent_tree_psy_abil3_001_desc_ru", {"loc_ability_psyker_overcharge_reduced_toughness_damage_taken_description"}, {"ru"}, function(locale, value) return "Пока перезаряжается {talent_name:%s}, вы получаете {tdr:%s} к "..COLORS_KWords_ru.Toughness_dmg_red_u_rgb_ru.."."..TALENTS_Enh_desc_ru.ED_PSY_Ability_3_1_rgb_ru end),
	...
	create_template("talent_tree_psy_abil3_002_desc_ru", {"loc_ability_psyker_overcharge_weakspot_description"}, {"ru"}, function(locale, value) return "Пока перезаряжается {talent_name:%s}, убийства в "..COLORS_KWords_ru.Weakspot_rgb_ru.." дают {second:%s} дополнительный заряд способности.\n\nЗа каждую секунду под действием таланта {talent_name:%s}, вы также получаете {finesse_damage_per_stack:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." от "..COLORS_KWords_ru.Finesse_rgb_ru..", до максимальных {max_finesse_damage:%s}. Эффект держится {duration:%s} секунд после окончания действия таланта {talent_name:%s}."..TALENTS_Enh_desc_ru.ED_PSY_Ability_3_2_rgb_ru end),
	...
	create_template("talent_tree_psy_abil3_003_desc_ru", {"loc_ability_psyker_overcharge_movement_speed_description"}, {"ru"}, function(locale, value) return "Пока перезаряжается {talent_name:%s}, вы получаете {movement_speed:%s} к скорости движения."..TALENTS_Enh_desc_ru.ED_PSY_Ability_3_3_rgb_ru end),
	...
	create_template("talent_tree_psy_abil3_004_desc_ru", {"loc_ability_psyker_overcharge_reduced_warp_charge_description"}, {"ru"}, function(locale, value) return "Пока перезаряжается {talent_name:%s}, вы получаете {warp_charge:%s} к генерации "..COLORS_KWords_ru.Peril_rgb_ru.."."..TALENTS_Enh_desc_ru.ED_PSY_Ability_3_4_rgb_ru end),
	...
	create_template("talent_tree_psy_abil3_005_desc_ru", {"loc_talent_psyker_overcharge_infinite_casting_desc"}, {"ru"}, function(locale, value) return "{talent_name:%s} теперь позволяет использовать все генерирующие "..COLORS_KWords_ru.Perl_rgb_ru.." действия без угрозы взрыва в течение "..COLORS_Numbers.n_10_rgb.." секунд, даже при "..COLORS_Numbers.pc_100_rgb.." "..COLORS_KWords_ru.Peril_rgb_ru.."."..TALENTS_Enh_desc_ru.ED_PSY_Ability_3_5_rgb_ru end),
...
--[+ +PASSIVES - ПАССИВНЫЕ+ +]--
	...
	create_template("talent_tree_psy_pas_016_desc_ru", {"loc_talent_psyker_force_staff_quick_attack_bonus_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.n_plus_rgb.."{damage_taken:%s} к "..COLORS_KWords_ru.Damagewrp_rgb_ru..", получаемому вашими врагами от ваших основных атак психосиловыми посохами. Максимум {max_stacks:%s} зарядов. Длится {duration:%s} секунд."..TALENTS_Enh_desc_ru.ED_PSY_Passive_16_rgb_ru end),
	...
	create_template("talent_tree_psy_pas_019_desc_ru", {"loc_talent_psyker_restore_toughness_to_allies_when_ally_down_description"}, {"ru"}, function(locale, value) return "Когда одного из союзников сбивают с ног, {toughness:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восстанавливается всем остальным союзникам в "..COLORS_KWords_ru.Coherency_rgb_ru.."."..TALENTS_Enh_desc_ru.ED_PSY_Passive_19_rgb_ru end),
	...
	create_template("talent_tree_psy_pas_025_desc_ru", {"loc_talent_psyker_damage_based_on_warp_charge_desc"}, {"ru"}, function(locale, value) return "До {max_damage:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." из всех источников в зависимости уровня вашей текущей "..COLORS_KWords_ru.Peril_rgb_ru.."."..TALENTS_Enh_desc_ru.ED_PSY_Passive_25_rgb_ru end),
...
--[+ +KEYSTONES - КЛЮЧЕВЫЕ+ +]--
	...
	create_template("talent_tree_zea_keys1_000_desc_ru", {"loc_talent_zealot_fanatic_rage_desc"}, {"ru"}, function(locale, value) return "Когда {max_stacks:%s} врагов погибает в радиусе {radius:%s} метров от вас, вы входите в "..COLORS_KWords_ru.Fury_rgb_ru.." и получаете {crit_chance:%s} к "..COLORS_KWords_ru.Crit_chance_rgb_ru.." на {duration:%s} секунд."..TALENTS_Enh_desc_ru.ED_ZEA_Keystone_1_rgb_ru end),
...
--[+ +PASSIVES - ПАССИВНЫЕ+ +]--
	...
	create_template("talent_tree_zea_pas_032_desc_ru", {"loc_talent_zealot_3_tier_3_ability_1_description"}, {"ru"}, function(locale, value) return "При получении вами "..COLORS_KWords_ru.Dmg_a_rgb_ru.." в ближнем бою, враг отбрасывается. Восстановление: {cooldown:%s} секунд."..TALENTS_Enh_desc_ru.ED_ZEA_Passive_32_rgb_ru end),
...
--[+ +PASSIVES - ПАССИВНЫЕ+ +]--
	...
	create_template("talent_tree_vet_pas_011_desc_ru", {"loc_talent_veteran_replenish_toughness_outside_melee_desc"}, {"ru"}, function(locale, value) return "{toughness:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восстанавливается в секунду, если в радиусе {range:%s} метров от вас нет врагов."..TALENTS_Enh_desc2_ru.ED_VET_Passive_11_rgb_ru end),
	...
	create_template("talent_tree_vet_pas_016_desc_ru", {"loc_talent_veteran_ranged_power_out_of_melee_desc"}, {"ru"}, function(locale, value) return "{ranged_damage:%s} к базовому "..COLORS_KWords_ru.Damage_rgb_ru.." для дальнобойных атак, если в радиусе {radius:%s} метров от вас нет врагов."..TALENTS_Enh_desc2_ru.ED_VET_Passive_16_rgb_ru end),
...
--[+ +BLITZ - БЛИЦ+ +]--
	...
	create_template("talent_tree_ogr_blitz0_000_desc_ru", {"loc_ability_ogryn_grenade_box_description"}, {"ru"}, function(locale, value) return "Вы бросаете коробку гранат с огромной силой и энтузиазмом, чтобы нанести высокий "..COLORS_KWords_ru.Dmg_rgb_ru.." одному врагу."..TALENTS_Enh_desc2_ru.ED_OGR_Blitz_0_rgb_ru end),
	...
	create_template("talent_tree_ogr_blitz1_000_desc_ru", {"loc_ability_ogryn_friend_rock_desc"}, {"ru"}, function(locale, value) return "Вы бросаете большой камень или обломок бетона в одного врага. Сниженная эффективность против врагов в панцирной броне и несгибаемых врагов. Вы подбираете новый камень каждые {recharge:%s} секунд и можете иметь при себе до {max_charges:%s} камней одновременно."..TALENTS_Enh_desc2_ru.ED_OGR_Blitz_1_rgb_ru end),
	...
	create_template("talent_tree_ogr_blitz3_000_desc_ru", {"loc_ability_ogryn_grenade_demolition_desc"}, {"ru"}, function(locale, value) return "Вы бросаете огринского размера "..COLORS_KWords_ru.Frag_gren_rgb_ru.." с радиусом взрыва до {radius:%s} метров, наносящую увеличенный "..COLORS_KWords_ru.Dmg_rgb_ru.." в центре."..TALENTS_Enh_desc2_ru.ED_OGR_Blitz_3_rgb_ru end),
...
--[+ +AURA - АУРА+ +]--
	...
	create_template("talent_tree_ogr_aura1_000_desc_ru", {"loc_talent_damage_aura_improved"}, {"ru"}, function(locale, value) return "{damage:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." тяжёлых атак ближнего боя для вас и союзников в "..COLORS_KWords_ru.Coherency_rgb_ru..".\n\nЭто улучшенная версия ауры {talent_name:%s}."..TALENTS_Enh_desc2_ru.ED_OGR_Aura_1_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_aura3_000_desc_fr", {"loc_talent_ogryn_damage_vs_suppressed_desc"}, {"fr"}, function(locale, value) return "{damage:%s} de "..COLORS_KWords_fr.Damage_rgb_fr.." contre les ennemis sous suppression pour vous et les alliés en syntonie."..TALENTS_Enh_desc2_fr.ED_OGR_Aura_3_rgb_fr end),
	--[+ Russian +]-- Отсев трусливых -- руоф Трусливые отбросы
	create_template("talent_tree_ogr_aura3_000_desc_ru", {"loc_talent_ogryn_damage_vs_suppressed_desc"}, {"ru"}, function(locale, value) return "{damage:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." по подавленным врагам для вас и союзников в "..COLORS_KWords_ru.Coherency_rgb_ru.."."..TALENTS_Enh_desc2_ru.ED_OGR_Aura_3_rgb_ru end),
...
--[+ +ABILITIES - СПОСОБНОСТЬ+ +]--
	...
	create_template("talent_tree_ogr_abil2_003_desc_ru", {"loc_talent_ogryn_taunt_radius_increase_desc"}, {"ru"}, function(locale, value) return COLORS_Numbers.n_plus_rgb.."{radius:%s} к радиусу действия способности {talent_name:%s}."..TALENTS_Enh_desc2_ru.ED_OGR_Ability_2_3_rgb_ru end),
	...
	create_template("talent_tree_ogr_abil3_002_desc_ru", {"loc_talent_ogryn_special_ammo_armor_pen_desc"}, {"ru"}, function(locale, value) return "{rending_multiplier:%s} к "..COLORS_KWords_ru.Rending_rgb_ru.." для ваших выстрелов во время действия способности {ability:%s}."..TALENTS_Enh_desc2_ru.ED_OGR_Ability_3_2_rgb_ru end),
	...
	create_template("talent_tree_ogr_abil3_003_desc_ru", {"loc_talent_ogryn_special_ammo_fire_shots_desc"}, {"ru"}, function(locale, value) return "Выстрелы накладывают {stacks:%s} заряда "..COLORS_KWords_ru.Burn_rgb_ru.." во время действия способности {ability:%s} ."..TALENTS_Enh_desc2_ru.ED_OGR_Ability_3_3_rgb_ru end),
...
--[+ +KEYSTONES - КЛЮЧЕВОЙ ТАЛАНТ+ +]--
	...
	create_template("talent_tree_ogr_keys1_000_desc_ru", {"loc_talent_ogryn_passive_heavy_hitter_desc"}, {"ru"}, function(locale, value) return "{damage:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." на {duration:%s} секунды при нанесении тяжёлых ударов. Суммируется {stacks:%s} раз."..TALENTS_Enh_desc2_ru.ED_OGR_Keystone_1_rgb_ru end),
	...
	create_template("talent_tree_ogr_keys1_001_desc_ru", {"loc_talent_ogryn_heavy_hitter_max_stacks_improves_attack_speed_description"}, {"ru"}, function(locale, value) return "{attack_speed:%s} к скорости атаки пока у вас {stacks:%s} зарядов таланта {talent_name:%s}."..TALENTS_Enh_desc2_ru.ED_OGR_Keystone_1_1_rgb_ru end),
	...
	create_template("talent_tree_ogr_keys1_002_desc_ru", {"loc_talent_ogryn_heavy_hitter_max_stacks_improves_toughness_description"}, {"ru"}, function(locale, value) return "{toughness_melee_replenish:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восстанавливается при убийствах в ближнем бою пока у вас {stacks:%s} зарядов таланта {talent_name:%s}."..TALENTS_Enh_desc2_ru.ED_OGR_Keystone_1_2_rgb_ru end),
	...
	create_template("talent_tree_ogr_keys1_003_desc_ru", {"loc_talent_ogryn_heavy_hitter_light_attacks_refresh_description"}, {"ru"}, function(locale, value) return "Действие таланта {talent_name:%s} обновляется лёгкими атаками."..TALENTS_Enh_desc2_ru.ED_OGR_Keystone_1_3_rgb_ru end),
	...
	create_template("talent_tree_ogr_keys3_000_desc_ru", {"loc_talent_ogryn_chance_to_not_consume_ammo_desc"}, {"ru"}, function(locale, value) return "{proc_chance:%s} шанс получить "..COLORS_KWords_ru.Lucky_bullet_rgb_ru.." и не потратить боеприпас при выстреле."..TALENTS_Enh_desc2_ru.ED_OGR_Keystone_3_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_keys3_002_desc_fr", {"loc_talent_ogryn_critical_leadbelcher_desc"}, {"fr"}, function(locale, value) return "Le tir qui déclenche "..COLORS_KWords_fr.Lucky_bullet_rgb_fr.." est un "..COLORS_KWords_fr.Crit_hit_rgb_fr.." garanti (s'il touche)."..TALENTS_Enh_desc2_fr.ED_OGR_Keystone_3_2_rgb_fr end),
	--[+ Russian +]-- Хорошая стрельба -- руоф Хороший выстрел
	create_template("talent_tree_ogr_keys3_002_desc_ru", {"loc_talent_ogryn_critical_leadbelcher_desc"}, {"ru"}, function(locale, value) return "Выстрел активировавший "..COLORS_KWords_ru.Lucky_bullet_rgb_ru.." гарантированно будет "..COLORS_KWords_ru.Crit_hit_om_rgb_ru.." (если попадёт)."..TALENTS_Enh_desc2_ru.ED_OGR_Keystone_3_2_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_keys3_003_desc_fr", {"loc_talent_ogryn_increased_leadbelcher_chance_desc"}, {"fr"}, function(locale, value) return "Votre chance de déclencher "..COLORS_KWords_fr.Lucky_bullet_rgb_fr.." est augmentée à {proc_chance:%s}." end),
	--[+ Russian +]-- Ещё больший обход ограничителя очереди! -- руоф Больше взлома ограничителя взрыва!
	create_template("talent_tree_ogr_keys3_003_desc_ru", {"loc_talent_ogryn_increased_leadbelcher_chance_desc"}, {"ru"}, function(locale, value) return "С "..COLORS_Numbers.pc_8_rgb.." до {proc_chance:%s} увеличивается шанс получить "..COLORS_KWords_ru.Lucky_bullet_rgb_ru.."." end),
...
--[+ +PASSIVES - ПАССИВНЫЕ+ +]--
	...
	create_template("talent_tree_ogr_pas_001_desc_ru", {"loc_talent_ogryn_damage_per_enemy_hit_previous_desc"}, {"ru"}, function(locale, value) return "Вы получаете "..COLORS_Numbers.n_1_rgb.." заряд {damage:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." за каждого поражённого врага в течение одной тяжёлой атаки ближнего боя. До "..COLORS_Numbers.n_plus_rgb..COLORS_Numbers.pc_25_rgb.." к "..COLORS_KWords_ru.Damage_rgb_ru.." при "..COLORS_Numbers.n_10_rgb.." зарядах. Рассчитывается отдельно для каждой атаки."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_1_rgb_ru end),
	...
	create_template("talent_tree_ogr_pas_003_desc_ru", {"loc_talent_ogryn_toughness_on_multiple_desc"}, {"ru"}, function(locale, value) return "{toughness:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восстанавливается при нанесении удара по нескольким врагам одной тяжёлой атакой ближнего боя."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_3_rgb_ru end),
	...
	--[+ Russian +]-- Тяжеловес 
	create_template("talent_tree_ogr_pas_004_desc_ru", {"loc_talent_ogryn_ogryn_fighter_desc"}, {"ru"}, function(locale, value) return "{damage:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." бастионам, жнецам, крушителям и чумным огринам. Также вы получаете {damage_reduction:%s} к сопротивлению "..COLORS_KWords_ru.Damage_rgb_ru.." от них."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_4_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_pas_005_desc_fr", {"loc_talent_ogryn_toughness_regen_while_bracing_desc"}, {"fr"}, function(locale, value) return "{toughness_regen:%s} de régénération de "..COLORS_KWords_fr.Toughness_rgb_fr.." lors de la mis en joue de votre arme à distance."..TALENTS_Enh_desc2_fr.ED_OGR_Passive_5_rgb_fr end),
	--[+ Russian +]-- Крепкий хват -- руоф Крепкая хватка
	create_template("talent_tree_ogr_pas_005_desc_ru", {"loc_talent_ogryn_toughness_regen_while_bracing_desc"}, {"ru"}, function(locale, value) return "{toughness_regen:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восстанавливается пока вы целитесь из дальнобойного оружия."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_5_rgb_ru end),
	...
	create_template("talent_tree_ogr_pas_006_desc_ru", {"loc_talent_ogryn_toughness_on_single_heavy_desc"}, {"ru"}, function(locale, value) return "{toughness:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восстанавливается после попадания по одному врагу тяжёлой атакой ближнего боя."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_6_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_pas_007_desc_fr", {"loc_talent_ogryn_coherency_toughness_increase_desc"}, {"fr"}, function(locale, value) return "{toughness_multiplier:%s} de "..COLORS_KWords_fr.Toughness_rgb_fr.." se régénère en étant en syntonie."..TALENTS_Enh_desc2_fr.ED_OGR_Passive_7_rgb_fr end),
	--[+ Russian +]-- Опора -- руоф Переломный момент
	create_template("talent_tree_ogr_pas_007_desc_ru", {"loc_talent_ogryn_coherency_toughness_increase_desc"}, {"ru"}, function(locale, value) return "{toughness_multiplier:%s} "..COLORS_KWords_ru.Toughness_rgb_ru.." восстанавливается пока вы в "..COLORS_KWords_ru.Coherency_rgb_ru.."."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_7_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_pas_008_desc_fr", {"loc_talent_ogryn_melee_stagger_desc"}, {"fr"}, function(locale, value) return "{stagger:%s} d'"..COLORS_KWords_fr.Impact_rgb_fr.." bonus sur les attaques de mêlée."..TALENTS_Enh_desc2_fr.ED_OGR_Passive_8_rgb_fr end),
	--[+ Russian +]-- Оплеуха -- руоф Хлопок
	create_template("talent_tree_ogr_pas_008_desc_ru", {"loc_talent_ogryn_melee_stagger_desc"}, {"ru"}, function(locale, value) return "{stagger:%s} к "..COLORS_KWords_ru.Impact_rgb_ru.." врагов от атак ближнего боя."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_8_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_pas_013_desc_fr", {"loc_talent_ogryn_increased_ammo_desc"}, {"fr"}, function(locale, value) return "Augmente votre réserve de munitions maximale de {max_ammo:%s}, arrondi à l'inférieur." end),
	--[+ Russian +]-- Схрон патронов 
	create_template("talent_tree_ogr_pas_013_desc_ru", {"loc_talent_ogryn_increased_ammo_desc"}, {"ru"}, function(locale, value) return "{max_ammo:%s} к максимальному количеству боеприпасов в резерве. Округляется в меньшую сторону." end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_pas_019_desc_fr", {"loc_talent_ogryn_bigger_coherency_radius_desc"}, {"fr"}, function(locale, value) return "{radius:%s} de rayon de syntonie."..TALENTS_Enh_desc2_fr.ED_OGR_Passive_19_rgb_fr end),
	--[+ Russian +]-- Величественное присутствие -- руоф Выдающееся присутствие
	create_template("talent_tree_ogr_pas_019_desc_ru", {"loc_talent_ogryn_bigger_coherency_radius_desc"}, {"ru"}, function(locale, value) return "{radius:%s} к радиусу "..COLORS_KWords_ru.Coherency_rgb_ru.."."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_19_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_pas_023_desc_fr", {"loc_talent_ogryn_revenge_damage_desc"}, {"fr"}, function(locale, value) return "{damage:%s} de "..COLORS_KWords_fr.Damage_rgb_fr.." pendant {duration:%s} secondes après avoir été touché par une attaque de mêlée."..TALENTS_Enh_desc2_fr.ED_OGR_Passive_23_rgb_fr end),
	--[+ Russian +]-- Время расплаты 
	create_template("talent_tree_ogr_pas_023_desc_ru", {"loc_talent_ogryn_revenge_damage_desc"}, {"ru"}, function(locale, value) return "{damage:%s} к "..COLORS_KWords_ru.Damage_rgb_ru.." на {duration:%s} секунд после того как вы получили "..COLORS_KWords_ru.Dmg_rgb_ru.." в ближнем бою или заблокировали атаку."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_23_rgb_ru end),
	...
	--[+ French +]--
	create_template("talent_tree_ogr_pas_025_desc_fr", {"loc_talent_ogryn_increase_explosion_radius_desc"}, {"fr"}, function(locale, value) return "Augmentez le rayon d'explosion de {explosion_radius:%s}."..TALENTS_Enh_desc2_fr.ED_OGR_Passive_25_rgb_fr end),
	--[+ Russian +]-- Большой бабах 
	create_template("talent_tree_ogr_pas_025_desc_ru", {"loc_talent_ogryn_increase_explosion_radius_desc"}, {"ru"}, function(locale, value) return "{explosion_radius:%s} к радиусу любых, вызванных вами, взрывов."..TALENTS_Enh_desc2_ru.ED_OGR_Passive_25_rgb_ru end),
